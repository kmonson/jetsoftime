...
import struct as st
from . import characterwriter as chars
...
def randomize_keys(char_locs, outfile, locked_chars):
    ...
    while len(loclist) != len(complete_list) and iterations != 3600:
        loclist = []
        keyitems = ["pop", "hilt", "blade", "stone", "knife", "gate", "jerky", "pendant", "moon", "prism", "masa2",
                    "clone",
                    "trigger", "medal", "ribbon"]
        locations = {"zenan": "", "taban": "", "denadoro": "", "snail": "", "burrow": "", "carpenter": "", "trial": "",
                     "melchior": "", "claw": "", "desert": "", "arris": "", "geno": "", "sun": "", "reptite": "",
                     "woe": ""}
