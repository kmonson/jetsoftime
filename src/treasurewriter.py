...
lowlvlchests = list(range(0x35F40C, 0x35F41C, 4)) + list(range(0x35F470, 0x35F484, 4)) + list(
    range(0x35F4A4, 0x35F4B0, 4)) \
...
lmidlvlchests = [0x35F464, 0x35F4C4, 0x35F4A0] + list(range(0x35F430, 0x35F440, 4)) + list(range(0x35F488, 0x35F49C, 4)) \
                + list(range(0x35F4B0, 0x35F4C8, 4)) + list(range(0x35F4D0, 0x35F4FC, 4)) + list(
    range(0x35F584, 0x35F5A4, 4))
midlvlchests = [0x35F428, 0x35F468, 0x35F46C, 0x35F49C, 0x35F4C8, 0x35F4CC, 0x35F6B8, 0x35F6BC, 0x35F6DC, 0x35F744,
                0x35F7DC] + \
               list(range(0x35F444, 0x35F464, 4)) + list(range(0x35F504, 0x35F530, 4)) + list(
    range(0x35F56C, 0x35F57C, 4)) + \
               list(range(0x35F580, 0x35F584, 4)) + list(range(0x35F678, 0x35F6A0, 4)) + list(
    range(0x35F6B8, 0x35F6D4, 4)) + \
...
mhighlvlchests = [0x35F484, 0x35F5E0, 0x35F650, 0x35F654, 0x35F6D8, 0x35F7A0] + list(range(0x35F430, 0x35F554, 4)) + \
                 list(range(0x35F5B8, 0x35F5CC, 4)) + list(range(0x35F5E8, 0x35F630, 4)) + list(
    range(0x35F630, 0x35F678, 4)) + \
                 list(range(0x35F6E4, 0x35F6F4, 4)) + list(range(0x35F77C, 0x35F798, 4)) + list(
    range(0x35F7A4, 0x35F7B0, 4)) + \
                 list(range(0x35F7B4, 0x35F7CC, 4)) + list(range(0x35F41C, 0x35F428, 4)) + list(
    range(0x35F5A4, 0x35F5B8, 4))
hawelvlchests = [0x35F798, 0x35F79C] + list(range(0x35F5CC, 0x35F5E0, 4)) + list(range(0x35F6A0, 0x35F6B8, 4)) + \
                list(range(0x35F6F4, 0x35F73C, 4)) + list(range(0x35F740, 0x35F744, 4)) + list(
    range(0x35F748, 0x35F77C, 4))
...
glvlitems = [0xAD, 0xB5, 0xB6, 0xB7, 0xA1, 0xA2, 0xAA, 0x09, 0x0A, 0x10, 0x17, 0x18, 0x26, 0x29, 0x35, 0x36, 0x40, 0x43,
             0x4D, 0x85,
