...
cyclone = {"attack_byte": 0x04, "effect": 0, "tech_id": 1,
           "efpointer": [3, 0, 0, 0x3A, 0x3B, 1, 0x3E, 0x80, 0x80, 0x0A, 4, 0],
           "anim": [1, 0xDA, 0xEF, 0x20, 1, 1, 0xFF],
           "text": [0xA2, 0xD2, 0xBC, 0xC5, 0xC8, 0xC7, 0xBE, 0xEF, 0xEF, 0xEF, 0xEF],
...
slash = {"attack_byte": 0x82, "effect": 7, "tech_id": 2, "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0x0A, 0, 0],
         "anim": [2, 0xE8, 0xEC, 0x21, 2, 2, 0xFF],
         "text": [0xB2, 0xC5, 0xBA, 0xCC, 0xC1, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
...
lightning = {"attack_byte": 0x82, "effect": 7, "tech_id": 3, "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0x0C, 0, 0],
             "anim": [3, 0xF1, 0, 0x22, 3, 3, 0x45],
             "text": [0x2F, 0xAB, 0xC2, 0xC0, 0xC1, 0xCD, 0xC7, 0xC2, 0xC7, 0xC0, 0xEF],
             "descpointer": [0x2B, 0x3B], "mp_cost": 4, "targeting": [7, 0]}
spincut = {"attack_byte": 0x04, "effect": 0, "tech_id": 4,
           "efpointer": [3, 0, 0, 0x3A, 0x3B, 1, 0x3E, 0x80, 0x80, 0x10, 4, 0x80],
           "anim": [4, 0xD6, 0, 0x27, 4, 4, 0xFF],
           "text": [0xB2, 0xC9, 0xC2, 0xC7, 0xBC, 0xCE, 0xCD, 0xEF, 0xEF, 0xEF, 0xEF],
           "descpointer": [0x39, 0x3B], "mp_cost": 6, "targeting": [7, 0]}
lightning2 = {"attack_byte": 0x82, "effect": 7, "tech_id": 5,
              "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0x0E, 0, 0],
              "anim": [5, 0xF1, 0, 0x22, 5, 3, 2],
              "text": [0x2F, 0xAB, 0xC2, 0xC0, 0xC1, 0xCD, 0xC7, 0xC2, 0xC7, 0xC0, 0xD6],
...
life = {"attack_byte": 0, "effect": 0, "tech_id": 6, "efpointer": [1, 0xD0, 0x80, 0, 0, 0, 0, 0xA0, 0, 0, 0, 0],
        "anim": [6, 0xE1, 2, 0x1B, 6, 6, 0x1D],
        "text": [0x2F, 0xAB, 0xC2, 0xBF, 0xBE, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
        "descpointer": [0x52, 0x3B], "mp_cost": 10, "targeting": [3, 0]}
confuse = {"attack_byte": 4, "effect": 0x14, "tech_id": 7,
           "efpointer": [8, 4, 0, 0x3A, 0x3B, 1, 0x3E, 0x80, 0x80, 0x1D, 4, 0],
           "anim": [7, 0x20, 0x24, 0x2D, 7, 7, 0xFF],
           "text": [0xA2, 0xC8, 0xC7, 0xBF, 0xCE, 0xCC, 0xBE, 0xEF, 0xEF, 0xEF, 0xEF],
...
luminaire = {"attack_byte": 0x82, "effect": 7, "tech_id": 8, "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0x32, 0, 0],
             "anim": [8, 0xFC, 0, 8, 8, 8, 1],
             "text": [0x2F, 0xAB, 0xCE, 0xC6, 0xC2, 0xC7, 0xBA, 0xC2, 0xCB, 0xBE, 0xEF],
...
aura = {"attack_byte": 0x00, "effect": 0, "tech_id": 9, "efpointer": [0, 8, 0x80, 0, 0, 0, 0, 0, 0, 0, 0, 0],
        "anim": [9, 0xE1, 0xE5, 0x1D, 9, 9, 0xFF],
        "text": [0xA0, 0xCE, 0xCB, 0xBA, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
        "descpointer": [0x96, 0x3B], "mp_cost": 1, "targeting": [0x80, 00]}
provoke = {"attack_byte": 0x02, "effect": 0, "tech_id": 0xA,
           "efpointer": [2, 1, 4, 00, 00, 0x50, 00, 0x70, 00, 00, 00, 00],
           "anim": [0x0A, 0x0A, 0x0E, 0x0E, 0x0A, 0x0A, 0xFF],
           "text": [0xAF, 0xCB, 0xC8, 0xCF, 0xC8, 0xC4, 0xBE, 0xEF, 0xEF, 0xEF, 0xEF],
           "descpointer": [0xA7, 0x3B], "mp_cost": 1, "targeting": [7, 0]}
ice = {"attack_byte": 0x22, "effect": 7, "tech_id": 0xB,
       "efpointer": [3, 00, 00, 00, 00, 3, 0x3C, 0x70, 0, 0x0C, 00, 00],
       "anim": [0x0C, 0xF4, 00, 0x25, 0x3A, 0x0C, 0x44],
       "text": [0x2F, 0xA8, 0xBC, 0xBE, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
       "descpointer": [0xB2, 0x3B], "mp_cost": 4, "targeting": [7, 0]}
cure = {"attack_byte": 0x00, "effect": 0, "tech_id": 0xC,
        "efpointer": [00, 0x0C, 0x80, 00, 00, 00, 00, 00, 00, 00, 00, 00],
        "anim": [0x0B, 0xE1, 2, 0x1E, 0x0B, 0x0B, 0xFF],
        "text": [0x2F, 0xA2, 0xCE, 0xCB, 0xBE, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
        "descpointer": [0xC3, 0x3B], "mp_cost": 4, "targeting": [0x80, 0]}
haste = {"attack_byte": 0x00, "effect": 0, "tech_id": 0xD,
         "efpointer": [2, 3, 0x80, 00, 00, 00, 00, 0x70, 00, 00, 00, 00],
         "anim": [0x0D, 0xBB, 00, 0x3E, 0x0D, 0x0D, 0x56],
         "text": [0x2F, 0xA7, 0xBA, 0xCC, 0xCD, 0xBE, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
         "descpointer": [0xD0, 0x3B], "mp_cost": 6, "targeting": [0, 0]}
ice2 = {"attack_byte": 0x22, "effect": 7, "tech_id": 0xE,
        "efpointer": [3, 00, 00, 00, 00, 3, 0x3C, 0x70, 00, 0x18, 00, 00],
        "anim": [0x0F, 0xFC, 00, 0x25, 0x3A, 0x0C, 0x57],
        "text": [0x2F, 0xA8, 0xBC, 0xBE, 0xFF, 0xD6, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
        "descpointer": [0xE7, 0x3B], "mp_cost": 8, "targeting": [8, 00]}
cure2 = {"attack_byte": 0x00, "effect": 0, "tech_id": 0xF,
         "efpointer": [1, 0x55, 0x80, 00, 00, 00, 00, 00, 00, 00, 00, 00],
         "anim": [0x0E, 0xE1, 2, 0x1F, 0x0B, 0x0E, 0xFF],
         "text": [0x2F, 0xA2, 0xCE, 0xCB, 0xBE, 0xFF, 0xD6, 0xEF, 0xEF, 0xEF, 0xEF],
         "descpointer": [0xFE, 0x3B], "mp_cost": 8, "targeting": [0x80, 0]}
life2 = {"attack_byte": 0x00, "effect": 0, "tech_id": 0x10,
         "efpointer": [1, 0xCF, 0x80, 00, 00, 00, 00, 0x80, 00, 00, 00, 00],
         "anim": [0x10, 0xE1, 2, 0x1B, 6, 6, 0x35],
         "text": [0x2F, 0xAB, 0xC2, 0xBF, 0xBE, 0xFF, 0xD6, 0xEF, 0xEF, 0xEF, 0xEF],
...
flametoss = {"attack_byte": 0x12, "effect": 7, "tech_id": 0x11, "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 6, 0, 0],
             "anim": [0x11, 0xEB, 0, 0x23, 0x11, 0x11, 0xFF],
             "text": [0xA5, 0xC5, 0xBA, 0xC6, 0xBE, 0xFF, 0xB3, 0xC8, 0xCC, 0xCC, 0xEF],
             "descpointer": [0x1E, 0x3C], "mp_cost": 1, "targeting": [0x0C, 5]}
hypnowave = {"attack_byte": 0x02, "effect": 0, "tech_id": 0x12,
             "efpointer": [2, 1, 2, 0, 0, 0x3C, 0x0A, 0x70, 0, 0, 0, 0],
             "anim": [0x12, 0xC9, 0xCD, 0x15, 0x12, 0x12, 7],
             "text": [0xA7, 0xD2, 0xC9, 0xC7, 0xC8, 0xFF, 0xB6, 0xBA, 0xCF, 0xBE, 0xEF],
...
fire = {"attack_byte": 0x12, "effect": 7, "tech_id": 0x13, "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0x0C, 0, 0],
        "anim": [0x13, 0xEB, 0, 0x23, 0x11, 0x13, 0xFF],
        "text": [0x2F, 0xA5, 0xC2, 0xCB, 0xBE, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
        "descpointer": [0x41, 0x3C], "mp_cost": 4, "targeting": [7, 0]}
napalm = {"attack_byte": 0x12, "effect": 7, "tech_id": 0x14,
          "efpointer": [3, 0, 0, 0x3A, 0x3B, 3, 0x3C, 0x50, 0, 0x12, 0, 0x80],
          "anim": [0x14, 0xF1, 0, 0x0A, 0x14, 0x14, 0x49],
          "text": [0xAD, 0xBA, 0xC9, 0xBA, 0xC5, 0xC6, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
...
protect = {"attack_byte": 0, "effect": 0, "tech_id": 0x15, "efpointer": [2, 4, 4, 0, 0, 0, 0, 0x70, 0, 0, 0, 0],
           "anim": [0x15, 0xCE, 0, 0x11, 0x15, 0x15, 0xFF],
           "text": [0x2F, 0xAF, 0xCB, 0xC8, 0xCD, 0xBE, 0xBC, 0xCD, 0xEF, 0xEF, 0xEF],
...
fire2 = {"attack_byte": 0x12, "effect": 7, "tech_id": 0x16, "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0x18, 0, 0],
         "anim": [0x16, 0xEB, 0, 0x0B, 0x11, 0x13, 0x1C],
         "text": [0x2F, 0xA5, 0xC2, 0xCB, 0xBE, 0xFF, 0xD6, 0xEF, 0xEF, 0xEF, 0xEF],
         "descpointer": [0x7E, 0x3C], "mp_cost": 8, "targeting": [8, 0]}
megabomb = {"attack_byte": 0x12, "effect": 7, "tech_id": 0x17,
            "efpointer": [3, 0, 0, 0x3A, 0x3B, 3, 0x3C, 0x50, 0, 0x20, 0, 0x80],
            "anim": [0x17, 0xCA, 0, 0x10, 0x17, 0x17, 0x20],
            "text": [0xAC, 0xBE, 0xC0, 0xBA, 0xFF, 0xA1, 0xC8, 0xC6, 0xBB, 0xEF, 0xEF],
...
flare = {"attack_byte": 0x12, "effect": 7, "tech_id": 0x18, "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0x32, 0, 0],
         "anim": [0x18, 0xF1, 0, 0xA, 0x18, 0x18, 0xD],
         "text": [0x2F, 0xA5, 0xC5, 0xBA, 0xCB, 0xBE, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
         "descpointer": [0xA9, 0x3C], "mp_cost": 0x14, "targeting": [8, 0]}
rocketpunch = {"attack_byte": 4, "effect": 0, "tech_id": 0x19,
               "efpointer": [3, 0, 0, 0x3A, 0x3B, 1, 0x3E, 0x80, 0x80, 0x0B, 4, 0x80],
               "anim": [0x19, 0xE6, 0xC3, 0x24, 0x19, 0x19, 0xFF],
               "text": [0xB1, 0xC8, 0xBC, 0xC4, 0xBE, 0xCD, 0xAF, 0xCE, 0xC7, 0xBC, 0xC1],
...
curebeam = {"attack_byte": 0, "effect": 0, "tech_id": 0x1A, "efpointer": [0, 0xC, 0x80, 0, 0, 0, 0, 0, 0, 0, 0, 0],
            "anim": [0x1A, 0xE1, 2, 0x1E, 0xB, 0xB, 0x5A],
            "text": [0xA2, 0xCE, 0xCB, 0xBE, 0xFF, 0xA1, 0xBE, 0xBA, 0xC6, 0xEF, 0xEF],
            "descpointer": [0xC9, 0x3C], "mp_cost": 1, "targeting": [0x80, 0]}
laserspin = {"attack_byte": 0x42, "effect": 7, "tech_id": 0x1B,
             "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0xC, 0, 0],
             "anim": [0x1C, 0x61, 0xE0, 0x26, 0x1B, 0x1B, 9],
             "text": [0xAB, 0xBA, 0xCC, 0xBE, 0xCB, 0xFF, 0xB2, 0xC9, 0xC2, 0xC7, 0xEF],
             "descpointer": [0xDA, 0x3C], "mp_cost": 6, "targeting": [8, 0]}
robotackle = {"attack_byte": 4, "effect": 0, "tech_id": 0x1C,
              "efpointer": [3, 0, 0, 0x3A, 0x3B, 1, 0x3E, 0x80, 0x80, 0x10, 4, 0x80],
              "anim": [0x1B, 0x61, 0xE0, 0x26, 0x1B, 0x1B, 9],
              "text": [0xB1, 0xC8, 0xBB, 0xC8, 0xFF, 0xB3, 0xBA, 0xBC, 0xC4, 0xC5, 0xBE],
...
healbeam = {"attack_byte": 0, "effect": 0, "tech_id": 0x1D, "efpointer": [0, 0xC, 0x80, 0, 0, 0, 0, 0, 0, 0, 0, 0],
            "anim": [0x1D, 0xE1, 2, 0x13, 0xB, 0xB, 0x59],
            "text": [0xA7, 0xBE, 0xBA, 0xC5, 0xFF, 0xA1, 0xBE, 0xBA, 0xC6, 0xEF, 0xEF],
            "descpointer": [0xF7, 0x3C], "mp_cost": 4, "targeting": [0x81, 0]}
uzzipunch = {"attack_byte": 4, "effect": 0, "tech_id": 0x1E,
             "efpointer": [3, 0, 0, 0x3A, 0x3B, 1, 0x3E, 0x80, 0x80, 0x19, 4, 0x80],
             "anim": [0x1E, 0xE6, 0xC3, 0x24, 0x19, 0x19, 0xFF],
             "text": [0xB4, 0xD3, 0xD3, 0xC2, 0xFF, 0xAF, 0xCE, 0xC7, 0xBC, 0xC1, 0xEF],
             "descpointer": [0xB, 0x3D], "mp_cost": 15, "targeting": [7, 0]}
areabomb = {"attack_byte": 0x12, "effect": 7, "tech_id": 0x1F,
            "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0x1E, 0, 0],
            "anim": [0x1F, 0xF1, 0xF5, 0xA, 0x1F, 0x1F, 0x50],
            "text": [0xA0, 0xCB, 0xBE, 0xBA, 0xFF, 0xA1, 0xC8, 0xC6, 0xBB, 0xEF, 0xEF],
...
shock = {"attack_byte": 0x82, "effect": 7, "tech_id": 0x20, "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0x28, 0, 0],
         "anim": [0x20, 0x61, 0, 1, 0, 0, 0x22],
         "text": [0xB2, 0xC1, 0xC8, 0xBC, 0xC4, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
...
slurp = {"attack_byte": 0, "effect": 0, "tech_id": 0x21, "efpointer": [0, 8, 0x80, 0, 0, 0, 0, 0, 0, 0, 0, 0],
         "anim": [0x21, 0xE1, 0, 0x1D, 9, 9, 0xFF],
         "text": [0xB2, 0xC5, 0xCE, 0xCB, 0xC9, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
         "descpointer": [0x51, 0x3D], "mp_cost": 1, "targeting": [0x80, 0]}
slurpcut = {"attack_byte": 4, "effect": 0, "tech_id": 0x22,
            "efpointer": [3, 0, 0, 0, 0, 1, 0x3E, 0xA0, 0x80, 0xB, 0x24, 0xC0],
            "anim": [0x22, 0xE1, 0, 0x1D, 9, 9, 0xFF],
            "text": [0xB2, 0xC5, 0xCE, 0xCB, 0xC9, 0xFF, 0xA2, 0xCE, 0xCD, 0xEF, 0xEF],
...
water = {"attack_byte": 0x22, "effect": 7, "tech_id": 0x23, "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0xC, 0, 0],
         "anim": [0x23, 0xF8, 0, 0x16, 0x23, 0x23, 0xFF],
         "text": [0x2F, 0xB6, 0xBA, 0xCD, 0xBE, 0xCB, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
...
heal = {"attack_byte": 0, "effect": 0, "tech_id": 0x24, "efpointer": [0, 0xC, 0x80, 0, 0, 0, 0, 0, 0, 0, 0, 0],
        "anim": [0x24, 0xE1, 2, 0x13, 0x24, 0x24, 0x58],
        "text": [0x2F, 0xA7, 0xBE, 0xBA, 0xC5, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
        "descpointer": [0x86, 0x3D], "mp_cost": 8, "targeting": [0x81, 0]}
leapslash = {"attack_byte": 4, "effect": 0, "tech_id": 0x25,
             "efpointer": [3, 0, 0, 0x3A, 0x3B, 1, 0x3E, 0x80, 0x80, 0x12, 4, 0x80],
             "anim": [0x25, 0x61, 5, 1, 0x25, 0x25, 0xFF],
             "text": [0xAB, 0xBE, 0xBA, 0xC9, 0xFF, 0xB2, 0xC5, 0xBA, 0xCC, 0xC1, 0xEF],
...
water2 = {"attack_byte": 0x22, "effect": 7, "tech_id": 0x26, "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0x18, 0, 0],
          "anim": [0x26, 0xF8, 0, 0x16, 0x23, 0x23, 0x32],
          "text": [0x2F, 0xB6, 0xBA, 0xCD, 0xBE, 0xCB, 0xFF, 0xD6, 0xEF, 0xEF, 0xEF],
...
cure2_2 = {"attack_byte": 0, "effect": 0, "tech_id": 0x27, "efpointer": [1, 0x55, 0x80, 0, 0, 0, 0, 0, 0, 0, 0, 0],
           "anim": [0x27, 0xE1, 2, 0x1F, 0xB, 0xE, 0xFF],
           "text": [0x2F, 0xA2, 0xCE, 0xCB, 0xBE, 0xFF, 0xD6, 0xEF, 0xEF, 0xEF, 0xEF],
...
frogsquash = {"attack_byte": 4, "effect": 0, "tech_id": 0x28, "efpointer": [3, 0, 0, 0, 0, 6, 0x3E, 0x60, 0, 0xA, 4, 0],
              "anim": [0x28, 0xE0, 0, 0x1C, 0x28, 2, 0x41],
              "text": [0xA5, 0xCB, 0xC8, 0xC0, 0xFF, 0xB2, 0xCA, 0xCE, 0xBA, 0xCC, 0xC1],
...
kiss = {"attack_byte": 0, "effect": 0, "tech_id": 0x29, "efpointer": [1, 0x50, 0x80, 0, 0, 0, 0, 0xA0, 0, 0, 0, 0],
        "anim": [0x29, 0xE1, 5, 0x1D, 9, 9, 0xFF],
        "text": [0xAA, 0xC2, 0xCC, 0xCC, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
        "descpointer": [0xE6, 0x3D], "mp_cost": 2, "targeting": [0x80, 0]}
rollokick = {"attack_byte": 4, "effect": 0, "tech_id": 0x2A,
             "efpointer": [3, 0, 0, 0x3A, 0x3B, 5, 0x3E, 0x80, 0, 0xE, 4, 0x80],
             "anim": [0x2A, 0x61, 5, 1, 0x25, 0x25, 0xFF],
             "text": [0xB1, 0xC8, 0xC5, 0xC5, 0xC8, 0xFF, 0xAA, 0xC2, 0xBC, 0xC4, 0xEF],
             "descpointer": [0xF9, 0x3D], "mp_cost": 2, "targeting": [7, 0]}
catattack = {"attack_byte": 4, "effect": 0, "tech_id": 0x2B,
             "efpointer": [3, 0, 0, 0x3A, 0x3B, 5, 0x3E, 0x80, 0, 0x19, 4, 0],
             "anim": [0x2B, 0x61, 0, 1, 0, 0, 0xFF],
             "text": [0xA2, 0xBA, 0xCD, 0xFF, 0xA0, 0xCD, 0xCD, 0xBA, 0xBC, 0xC4, 0xEF],
             "descpointer": [8, 0x3E], "mp_cost": 4, "targeting": [7, 0]}
rockthrow = {"attack_byte": 4, "effect": 0, "tech_id": 0x2C,
             "efpointer": [3, 0, 0, 0x3A, 0x3B, 5, 0x3E, 0x80, 0, 0x1E, 0x46, 0xC0],
             "anim": [0x2C, 0x61, 0, 1, 0, 0, 0xFF],
             "text": [0xB1, 0xC8, 0xBC, 0xC4, 0xFF, 0xB3, 0xC1, 0xCB, 0xC8, 0xD0, 0xEF],
...
charm = {"attack_byte": 2, "effect": 0xF, "tech_id": 0x2D, "efpointer": [6, 0x46, 0, 0, 0, 0, 0, 0x80, 0, 0, 0, 0x80],
         "anim": [0x2D, 0xC0, 5, 0xF, 0x2D, 0x2D, 0xFF],
         "text": [0xA2, 0xC1, 0xBA, 0xCB, 0xC6, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
...
tailspin = {"attack_byte": 2, "effect": 0, "tech_id": 0x2E, "efpointer": [3, 0, 0, 0, 0, 3, 0, 0x70, 0, 0xC, 0, 0],
            "anim": [0x2F, 0x61, 0, 1, 0, 0, 6],
            "text": [0xB3, 0xBA, 0xC2, 0xC5, 0xFF, 0xB2, 0xC9, 0xC2, 0xC7, 0xEF, 0xEF],
...
dinotail = {"attack_byte": 4, "effect": 0, "tech_id": 0x2F, "efpointer": [3, 0, 0, 0, 0, 6, 0x3E, 0xA0, 0, 9, 4, 0],
            "anim": [0x30, 0x61, 0, 1, 0x30, 1, 0xE],
            "text": [0xA3, 0xC2, 0xC7, 0xC8, 0xFF, 0xB3, 0xBA, 0xC2, 0xC5, 0xEF, 0xEF],
            "descpointer": [0x48, 0x3E], "mp_cost": 15, "targeting": [8, 0]}
triplekick = {"attack_byte": 4, "effect": 0x13, "tech_id": 0x30,
              "efpointer": [8, 3, 0, 0x3A, 0x3B, 5, 0x3E, 0x80, 0, 0x32, 4, 0],
              "anim": [0x2E, 0x61, 5, 1, 0x25, 0x25, 0xFF],
              "text": [0xB3, 0xCB, 0xC2, 0xC9, 0xC5, 0xBE, 0xFF, 0xAA, 0xC2, 0xBC, 0xC4],
              "descpointer": [0x5C, 0x3E], "mp_cost": 20, "targeting": [7, 0]}
lightning2_2 = {"attack_byte": 0x82, "effect": 7, "tech_id": 0x31,
                "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0xC, 0, 0],
                "anim": [0x31, 0xF1, 0, 0x22, 3, 3, 2],
                "text": [0x2F, 0xAB, 0xC2, 0xC0, 0xC1, 0xCD, 0xC7, 0xC2, 0xC7, 0xC0, 0xD6],
...
ice2_2 = {"attack_byte": 0x22, "effect": 7, "tech_id": 0x32, "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0xC, 0, 0],
          "anim": [0x35, 0xFC, 0, 0x25, 0x3A, 0xC, 0x57],
          "text": [0x2F, 0xA8, 0xBC, 0xBE, 0xFF, 0xD6, 0xEF, 0xEF, 0xEF, 0xEF, 0xEF],
...
fire2_2 = {"attack_byte": 0x12, "effect": 7, "tech_id": 0x33, "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0xC, 0, 0],
           "anim": [0x33, 0xEB, 0, 0xB, 0x11, 0x13, 0x1C],
           "text": [0x2F, 0xA5, 0xC2, 0xCB, 0xBE, 0xFF, 0xD6, 0xEF, 0xEF, 0xEF, 0xEF],
           "descpointer": [0x9E, 0x3E], "mp_cost": 4, "targeting": [8, 0]}
darkbomb = {"attack_byte": 0x42, "effect": 7, "tech_id": 0x34,
            "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0x19, 0, 0],
            "anim": [0x34, 0xF1, 4, 0xA, 0x34, 0x34, 0x21],
            "text": [0x2F, 0xA3, 0xBA, 0xCB, 0xC4, 0xFF, 0xA1, 0xC8, 0xC6, 0xBB, 0xEF],
...
magicwall = {"attack_byte": 0, "effect": 0, "tech_id": 0x35, "efpointer": [2, 4, 0x40, 0, 0, 0, 0, 0x70, 0, 0, 0, 0],
             "anim": [0x36, 0xCE, 4, 0x12, 0x34, 0x36, 0xFF],
             "text": [0x2F, 0xAC, 0xBA, 0xC0, 0xC2, 0xBC, 0xFF, 0xB6, 0xBA, 0xC5, 0xC5],
             "descpointer": [0xCA, 0x3E], "mp_cost": 6, "targeting": [0, 0]}
darkmist = {"attack_byte": 0x42, "effect": 7, "tech_id": 0x36,
            "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0x19, 0, 0],
            "anim": [0x32, 0xF8, 4, 0xA, 0x34, 0x34, 0x2F],
            "text": [0x2F, 0xA3, 0xBA, 0xCB, 0xC4, 0xFF, 0xAC, 0xC2, 0xCC, 0xCD, 0xEF],
...
blackhole = {"attack_byte": 2, "effect": 0x24, "tech_id": 0x37, "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 2, 0, 0],
             "anim": [0x37, 0xF1, 4, 0xA, 0x34, 0x34, 8],
             "text": [0x2F, 0xA1, 0xC5, 0xBA, 0xBC, 0xC4, 0xFF, 0xA7, 0xC8, 0xC5, 0xBE],
             "descpointer": [0xF3, 0x3E], "mp_cost": 15, "targeting": [0x1B, 0xA]}
darkmatter = {"attack_byte": 0x42, "effect": 7, "tech_id": 0x38,
              "efpointer": [3, 0, 0, 0, 0, 3, 0x3C, 0x70, 0, 0x2A, 0, 0],
              "anim": [0x38, 0xF1, 4, 0xA, 0x34, 0x34, 0x1E],
              "text": [0x2F, 0xA3, 0xBA, 0xCB, 0xC4, 0xAC, 0xBA, 0xCD, 0xCD, 0xBE, 0xCB],
              "descpointer": [2, 0x3F], "mp_cost": 20, "targeting": [8, 0]}
new_ids = {"cyclone": "", "slash": "", "lightning": "", "spincut": "", "lightning2": "", "life": "", "confuse": "",
           "luminaire": "", "aura": "", "provoke": "", "ice": "", "cure": "", "haste": "", "ice2": "", "cure2": "",
           "life2": "",
           "flametoss": "", "hypnowave": "", "fire": "", "napalm": "", "protect": "", "fire2": "", "megabomb": "",
           "flare": "",
           "rocketpunch": "", "curebeam": "", "laserspin": "", "robotackle": "", "healbeam": "", "uzzipunch": "",
           "areabomb": "", "shock": "", "slurp": "", "slurpcut": "", "water": "", "heal": "", "leapslash": "",
           "water2": "",
           "cure2_2": "", "frogsquash": "", "kiss": "", "rollokick": "", "catattack": "", "rockthrow": "", "charm": "",
           "tailspin": "", "dinotail": "", "triplekick": "", "lightning2_2": "", "ice2_2": "", "fire2_2": "",
           "darkbomb": "",
...
def randomize_tech_order(character):
    ...
    new_id_names = ["cyclone", "slash", "lightning", "spincut", "lightning2", "life", "confuse", "luminaire", "aura",
                    "provoke", "ice", "cure", "haste", "ice2", "cure2", "life2", "flametoss", "hypnowave", "fire",
                    "napalm",
                    "protect", "fire2", "megabomb", "flare", "rocketpunch", "curebeam", "laserspin", "robotackle",
                    "healbeam",
                    "uzzipunch", "areabomb", "shock", "slurp", "slurpcut", "water", "heal", "leapslash", "water2",
                    "cure2_2",
                    "frogsquash", "kiss", "rollokick", "catattack", "rockthrow", "charm", "tailspin", "dinotail",
                    "triplekick",
