...
def scale_stats(bosspower, boss, pointer):
    ...
    if boss == rusttyrano:
        if bosspower < 2:
            ...
            boss_stats = [8000, 30, 30, 50, 180, 127, 4000, 8000, 70]
    if boss == dragon_tank:
        if bosspower < 2:
            boss_stats = [1100, 15, 15, 60, 50, 160, 1600, 2500, 26]
        else:
            boss_stats = [1300, 30, 30, 60, 100, 160, 2200, 4000, 36]
    if boss == dragon_wheel:
        if bosspower < 2:
            boss_stats = [1000, 25, 25, 60, 42, 160]
        else:
            boss_stats = [1100, 25, 25, 60, 85, 160]
    if boss == dragon_head:
        if bosspower < 2:
            boss_stats = [1400, 20, 20, 60, 50, 160]
        else:
            boss_stats = [1600, 30, 30, 60, 50, 160]
    if boss == sonofsun:
        if bosspower < 2:
    ...
    if boss == nizbel:
        if bosspower < 2:
            ...
            boss_stats = [8000, 40, 40, 65, 190, 253, 6000, 6800, 65]
    if boss == retinite_head or boss == retinite_legs:
        if bosspower < 2:
            ...
            boss_stats = [2400, 25, 25, 70, 190, 178, 1600, 0, 16]
    if boss == retinite_core:
        if bosspower < 2:
            ...
            boss_stats = [900, 15, 19, 70, 50, 178, 3200, 3300, 50]
    if boss == yakraxiii:
        if bosspower < 2:
            ...
            boss_stats = [6300, 17, 18, 50, 150, 127, 4000, 5000, 70]
    if boss == guardian:
        if bosspower < 2:
            ...
            boss_stats = [4300, 30, 30, 50, 16, 127, 3500, 5000, 50]
    if boss == bit:
        if bosspower < 2:
            ...
            boss_stats = [500, 17, 17, 50, 74, 127]
    if boss == motherbrain:
        if bosspower < 2:
            ...
            boss_stats = [4500, 40, 40, 50, 100, 127, 4300, 6000, 70]
    if boss == display:
        if bosspower < 2:
            ...
            boss_stats = [1, 15, 25, 50, 144, 127]
    if boss == rseries:
        if bosspower < 2:
            boss_stats = [1200, 15, 15, 50, 52, 127, 500, 400, 10]
        else:
            boss_stats = [1400, 20, 20, 50, 75, 127, 600, 600, 15]
    if boss == giga_gaia:
        if bosspower < 2:
            ...
            boss_stats = [10000, 32, 15, 50, 50, 127, 7000, 9200, 110]
    if boss == gaia_left:
        if bosspower < 2:
            ...
            boss_stats = [3500, 40, 30, 61, 40, 127]
    if boss == gaia_right:
        if bosspower < 2:
            ...
            boss_stats = [3500, 40, 30, 50, 60, 158]
